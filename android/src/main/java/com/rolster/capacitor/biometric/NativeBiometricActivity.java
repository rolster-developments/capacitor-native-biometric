...
public class NativeBiometricActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (useFallback) {
      ...
      // and must NOT be set if the latter is enabled via `setAllowedAuthenticators`
      ...
      builder.setNegativeButtonText(
          getIntent().hasExtra("negativeButtonText") ? getIntent().getStringExtra("negativeButtonText")
              : "Cancel");
    }
